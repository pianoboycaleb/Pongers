...
label start:
    ...
    $ s_name = "Sayori"
    $ m_name = persistent.monikaname
    $ n_name = "Natsuki"
    $ y_name = "Yuri"
    if we == "we":
        $ persistent.selves, persistent.was, persistent.plu, persistent.plu2, persistent.our, persistent.weve, persistent.plu3, persistent.have, persistent.are, persistent.are2, persistent.were, persistent.well = "selves", "were", "", "", "our", "we've", "y", "have", "are", "are", "we're", "we'll"
    $ heC = he.capitalize()
    $ himC = him.capitalize()
    $ areC = are.capitalize()
    $ are2C = are2.capitalize()
    $ hesC = hes.capitalize()
    $ wasC = was.capitalize()
    $ weC = we.capitalize()
    $ haveC = have.capitalize()
    $ pluC = plu.capitalize()
    $ plu2C = plu2.capitalize()
    $ plu3C = plu3.capitalize()
    $ selvesC = selves.capitalize()
    $ wereC = were.capitalize()
    $ wellC = well.capitalize()
    $ ourC = our.capitalize()
    $ weveC = weve.capitalize()
