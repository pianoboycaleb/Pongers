...
style _base_phone_text is empty:
    ...
    line_spacing 1
    color "#fff"
    font "mod_assets/RedHatText-Regular.otf"
    size 28
...
screen phone_call():
    ...
    use _phone(xpos=gui.phone_call_xpos):
        ...
        vbox:
            style_prefix "phone_other_menu"

            imagebutton:
                idle "mod_assets/phone/hang_up_idle.png"
                hover "mod_assets/phone/hang_up_selected.png"
                selected_idle "mod_assets/phone/hang_up_selected.png"
                action MainMenu()
...
style phone_say_dialogue is _base_phone_text:
    ...
    text_align 0.5
    ypos 0.0
    outlines [(1.5,"#0f0f0f", 0, 0)]
    font "mod_assets/metropolis.regular.otf"
    size 28

style phone_say_label is phone_say_dialogue:
    font "mod_assets/metropolis.semi-bold.otf"
    size 36
...
style phone_other_menu_vbox:
    xalign 0.5 ypos 0.83
