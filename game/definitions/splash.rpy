...
init python:
    ...
    # the game launches.
    splash_message_default = "if you're looking at the code to find extra splash messages, fuck you (affectionate)"
    ...
    splash_messages = [
        ...
        "WARIOOOOOOOOOO I GOTTA WINNNNNN",
        "If only I could feel your touch...",
        "Don't play Monika After Story at 3 AM",
        "Never download Monika After Story\nWorst mistake of my life",
        "Natsuki is superior",
        "Did you know that DDLC+ was originally going to be cheaper, but was made more expensive due to the lesser value of the American dollar?\nFor more information, Google 'doki doki inflation'",
        "If you're seeing this, you're cool",
        "How many splash messages can you find? Collect them all!",
        "yurk killed herself! pogger!",
        "Exit Music 3 when",
        "Play The Monika Mod",
        "DDLC will never die",
        "Hey, it's me! I'm so glad you're playing this silly little mod. Hopefully you don't hate it!",
        "I wonder if anyone else has made this many different splash messages",
        "play exit music epilogue",
        "hey you\nyeah you\nyou should smile",
        "Happy April late fools lmao",
        "Read Homestuck",
        "Play Emerald Affection",
        "Play GHY: Origin Arc",
        "Woooaaaaaooaowaooaaaaowaoaoaa Story of Undertale",
        "im so sorry for all the questions elckarow :fridge:",
        "Do you ever feel.....like a plastic bag?",
        "CAUSE IM A CREEP\nI'M A WEIRDO\n\nWHAT THE HELL AM I DOING HEEEEERRREEEEE",
        "https://tinyurl.com/itstotallynotarickrollipromise",
        "Also try Minecraft!\n\n\nwait wrong game",
        "hey tulkas thanks for porting this to android",
        "Tip: turn on/off Goofy Goober mode in the settings to see a new splash image without restarting the game",
        "Don't read Homestuck^2",
        "Warning: You are playing an outdated version of the mod.\nPlease download the newest version from Reddit.",
        "If DDLC is so good why don't they make DDLC 2",
        "First person to go to this link gets free Nitro:\nhttps://discord.gift/f2DWWPu85AEeyrd5\nI'm completely serious I literally bought gift Nitro for this splash message",
        "Turn on Goofy Goober mode to make this mod awful",
        "... .... --- ..- - --- ..- - / - --- / ..- -. -.. . .-. -.-. ..- .-. .-. . -. - ...",
        "shoutouts to Lameman",
        "crased or bringe? you decide",
        "(248) 434-5508\nCall this number, I promise on my life it's worth it",
        "God I hope these all work",
        "hi :)",
        "I would give anything to be stuck with you.",
        "uhhhhhhhhhhh more ideas for a splash message umm uh umm oh i got one:\nim gonna glomp you",
        "check the settings",
        "there is a bomb implanted in my man tits",
        "boobieloverfan103 is the best reddit account",
        "boobieloverfanfan103 is the second best reddit account",
        ":randomguy:",
        "If this is the one of the splash messages you see, then you win a prize! The prize is knowing there are exactly 50 messages including this one. Good luck!"
    ]
...
image menu_sayo:
    perspective True
    "mod_assets/phanthom goofysayo.png"
    truecenter
    zoom 0.8
    menu_sayo_move

image menu_monika:
    "mod_assets/matrix.png"
    truecenter
    zoom 0.8
    menu_monika_move
...
image game_menu_bg:
    "mod_assets/nightbg.png"

image game_menu_bggoofy:
    "mod_assets/m_odst.png"
    zoom 1.4
...
image menu_goofybg:
    subpixel True
    truecenter
    "mod_assets/that_couch.jpg"
    zoom 0.8

image menu_goofylogo:
    "mod_assets/goofypongers.png"
    truecenter
    yoffset 36
    zoom 1.1
    menu_logo_move
...
image menu_fog2:
    SnowBlossom("mod_assets/fog-particle.png", count=80, border=600, xspeed=50, yspeed=0, start=5, fast=True, horizontal=True)

image menu_fog1:
    im.Tile(im.Scale("mod_assets/fog.png", 1600, 600), size=(2400, 800))
    menu_fogmove

transform menu_fogmove:   
    parallel:
        xoffset 0 yoffset 0
        linear 3.0 xoffset 1600
        repeat
...
transform splash2move:
    subpixel True
    rotate 30
    ease_cubic 0.8 zoom 1.4
    ease_cubic 0.8 zoom 0.8
    repeat
...
transform menu_logo_move:
    ...
    alpha 0.0
    time 1.0
    easein 2.0 alpha 1.0 zoom 1.1

transform menu_monika_move:
    subpixel True
    alpha 0.0
    time 1.0
    easein 3.0 alpha 1.0

transform menu_sayo_move:
    yoffset 0.5
    xoffset 0.5
    parallel:
        matrixtransform RotateMatrix(0.0, 0.0, 0.0)
        linear 1.5 matrixtransform RotateMatrix(360.0, 0.0, 0.0)
        repeat
    parallel:
        matrixtransform RotateMatrix(0.0, 0.0, 0.0)
        linear 1.5 matrixtransform RotateMatrix(0.0, 360.0, 0.0)
        repeat
    parallel:
        zoom 1.0
        linear 0.25 zoom 0.3
        linear 0.25 zoom 0.5
        linear 0.25 zoom 0.2
        linear 0.25 zoom 0.8
        linear 0.25 zoom 0.1
        linear 0.25 zoom 0.6
        linear 0.25 zoom 0.4
        linear 0.25 zoom 0.9
        repeat
    parallel:
        matrixcolor TintMatrix("#f00")
        linear 0.2 matrixcolor TintMatrix("#d12626")
        linear 0.2 matrixcolor TintMatrix("#cf7d13")
        linear 0.2 matrixcolor TintMatrix("#d9d21c")
        linear 0.2 matrixcolor TintMatrix("#92e043")
        linear 0.2 matrixcolor TintMatrix("#36cf73")
        linear 0.2 matrixcolor TintMatrix("#3dd4d9")
        linear 0.2 matrixcolor TintMatrix("#5d71f5")
        linear 0.2 matrixcolor TintMatrix("#ab52eb")
        linear 0.2 matrixcolor TintMatrix("#e354bd")
        linear 0.2 matrixcolor TintMatrix("#f26183")
        repeat
...
label splashscreen:
    ...
    if not persistent.first_run:
        ...
        ## get DDLC's files."
        "[config.name] is a Doki Doki Literature Club fan mod that is not affiliated in any way with Team Salvato. Also, it's not affiliated with your mom."
        "It is designed to be played only after the official game has been completed, and contains spoilers for the official game."
        "It's also advised that you know about the mod Monika After Story, as well as background information about the fanbase of it."
        "It's not required, but this mod contains references to how MAS works and how the players act."
        "Game files for Doki Doki Literature Club are required to play this mod and can be downloaded for free at: https://ddlc.moe. Don't use Steam for mods."
        "Hey, I wonder how many people just skip past all of this dialogue?"
        "Honestly, I probably do it most of the time, since it's usually the same old, same old."
        "But sometimes it's a bit different, usually for more comedic mods, but whatever."
        "I bet if you are just skipping past this, you might have noticed there's a bit more dialogue than usual, and perhaps are noticing that I'm just talking to you now."
        menu:
            "Did you actually read all of that?"
            "Yeah":
                $ persistent.reader = True
                pass
            "Read what":
                pass
        if persistent.reader:
            "Wow, thanks! Anyways, I'll let you go now."
            "Hope you enjoy!"
            pass
        else:
            "You know what? That's really quite understandable. But I spent at least 1 minute typing that, and you just ignored it, so I'm feeling a little hurt."
            "Oh well, I guess some things can't be helped."
            "I hope you read the actual mod, though."
            "I plan to work pretty hard on it. (I haven't written the script yet as of writing this message.)"

        menu:
            "By playing [config.name] you agree that you have completed Doki Doki Literature Club and accept any spoilers contained within. (omg within like the mod within)"
            "I agree.":
                pass
    ...
    if persistent.goofygoober_mode:
        show black
        $ config.main_menu_music = audio.goofymenu
        $ renpy.music.play(config.main_menu_music)
